...
SECRET_KEY = 'django-insecure-!6$7=h%v=pj%*#j_2@*v-@z0q&1$*=bg+s9v!ln$kz_snm2_(l'
...
# Use simple JWT (recommended) or DRF token
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': (
        'rest_framework_simplejwt.authentication.JWTAuthentication',
        # 'rest_framework.authentication.TokenAuthentication',  # alt
    ),
